...
export const translations = {
  en: {
    ...
    forteenProjectInfo: "Implementation of the previous project (Gallery) written in Angular with some differences",
    fifteenProjectInfo: 'An embeddable weather widget written in React using TypeScript',
  ...
  ru: {
    ...
    forteenProjectInfo: "Реализация предыдущего проекта (Gallery) написанная на Angular с некоторыми отличиями",
    fifteenProjectInfo: 'Встраиваемый погодный виджет написанный на React с использованием TypeScript',
