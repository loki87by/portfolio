import { HSL, Wide, Solve } from "./types";
...
class Solver {
  ...
  solveWide(): Wide {
    ...
    let best = { loss: Infinity, values: [NaN] };
...
export function hexToRgb(hex: string, hsl?: boolean): HSL | number[] | null {
...
export function getFilter(value: string): string {
