...
export const translations = {
  en: {
    ...
    arkanoidInfo: 'Arkanoid game with auto-generated levels (after the second one)',
  ...
  ru: {
    ...
    arkanoidInfo: 'Игра арканоид с автоматически генерируемыми уровнями (после второго)',
