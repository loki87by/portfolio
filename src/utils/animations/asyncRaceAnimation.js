// TODO: SET TIMING!!!
export default function asyncRaceAnimation(array, element) {
  let timersArray = [];
  ...
  const timer31 = setTimeout(() => {
    element.removeAttribute("style");
    element.setAttribute("style", `background-image: url(${array[31]});`);
  }, 9150);
  timersArray.push(timer31);
  const timer32 = setTimeout(() => {
    element.removeAttribute("style");
    element.setAttribute("style", `background-image: url(${array[32]});`);
  }, 10150);
  timersArray.push(timer32);
  const timer33 = setTimeout(() => {
    element.removeAttribute("style");
    element.setAttribute("style", `background-image: url(${array[33]});`);
  }, 10350);
  timersArray.push(timer33);
  const timer34 = setTimeout(() => {
    element.removeAttribute("style");
    element.setAttribute("style", `background-image: url(${array[34]});`);
  }, 10550);
  timersArray.push(timer34);
  const timer35 = setTimeout(() => {
    element.removeAttribute("style");
    element.setAttribute("style", `background-image: url(${array[35]});`);
  }, 10750);
  timersArray.push(timer35);
  const timer36 = setTimeout(() => {
    element.removeAttribute("style");
    element.setAttribute("style", `background-image: url(${array[36]});`);
  }, 10950);
  timersArray.push(timer36);
  const timer37 = setTimeout(() => {
    element.removeAttribute("style");
    element.setAttribute("style", `background-image: url(${array[37]});`);
  }, 11250);
  timersArray.push(timer37);
  const timer38 = setTimeout(() => {
    element.removeAttribute("style");
    element.setAttribute("style", `background-image: url(${array[38]});`);
  }, 11550);
  timersArray.push(timer38);
  const timer39 = setTimeout(() => {
    element.removeAttribute("style");
    element.setAttribute("style", `background-image: url(${array[39]});`);
  }, 11750);
  timersArray.push(timer39);
  const timer40 = setTimeout(() => {
    element.removeAttribute("style");
    element.setAttribute("style", `background-image: url(${array[40]});`);
  }, 11950);
  timersArray.push(timer40);
  const timer41 = setTimeout(() => {
    element.removeAttribute("style");
    element.setAttribute("style", `background-image: url(${array[41]});`);
  }, 12150);
  timersArray.push(timer41);
  const timer42 = setTimeout(() => {
    element.removeAttribute("style");
    element.setAttribute("style", `background-image: url(${array[42]});`);
  }, 12550);
  timersArray.push(timer42);
  ...
  const timer44 = setTimeout(() => {
    element.removeAttribute("style");
    element.setAttribute("style", `background-image: url(${array[44]});`);
  }, 14150);
  timersArray.push(timer44);
  ...
  const timer47 = setTimeout(() => {
    element.removeAttribute("style");
    element.setAttribute("style", `background-image: url(${array[47]});`);
  }, 15000);
  timersArray.push(timer47);
  return timersArray;
}
