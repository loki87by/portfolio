...
function diplomAnimation(array, element) {
  ...
  const timer21 = setTimeout(() => {
    ...
    element.setAttribute(
      "style",
      `background-image: url(${array[17]}); background-position-y: bottom; transition: background-position-y 1.5s`
    );
  }, 9200);
  ...
  const timer22 = setTimeout(() => {
    ...
    element.setAttribute(
      "style",
      `background-image: url(${array[17]}); background-position-y: top; transition: background-position-y 1.5s`
    );
  }, 10700);
